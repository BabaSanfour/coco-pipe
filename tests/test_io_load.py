...
def test_load_data_explicit_modes():
    ...
    with patch("coco_pipe.io.load.TabularDataset") as mock_tab:
        ...
        mock_tab.assert_called_with(
            path=p, target_col=None, index_col=None, sep=",", 
            header=0, sheet_name=0, columns_to_dims=None, col_sep="_",
            meta_columns=None, clean=False, clean_kwargs=None
        )
    ...
    with patch("coco_pipe.io.load.BIDSDataset") as mock_bids:
        ...
        mock_bids.assert_called_with(
            root=p, mode="epochs", task="rest", session=None, 
            datatype="eeg", suffix=None, window_length=None, 
            stride=None, subjects=None
        )
    ...
    with patch("coco_pipe.io.load.EmbeddingDataset") as mock_emb:
        ...
        mock_emb.assert_called_with(
            path=p, pattern="*.npy", dims=("obs", "feature"), 
            coords=None, reader=None, id_fn=None, subjects=None
        )
